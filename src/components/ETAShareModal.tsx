          ...
          {viewMode === 'share' ? (
            <>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1.5 mb-2">
                  {recipientPresets.map((name) => (
                    <button
                      key={name}
                      type="button"
                      onClick={() => onUpdateRecipientName(name)}
                      className={`px-3 py-1 rounded-xl text-xs font-medium border cursor-pointer ${
                        sharedState.recipientName === name
                ...
                <input
                  type="text"
                  value={sharedState.recipientName}
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold flex items-center gap-1 transition-colors cursor-pointer"
                  >
